# Replication Code for Multi-Method Approach Paper
...
- `multilevelsem2026_multimethod_all.R` - Main R script containing all analyses.
- `Figure1_architecture multi-method.png` to `Figure6_Profile_Comparison.png` - All figures from the manuscript.
- `LICENSE` - MIT License.

## How to Run
1. Open `multilevelsem2026_multimethod_all.R` in RStudio.
2. Install required packages: `blavaan`, `randomForest`, `mclust`, `tidyverse`, etc.
